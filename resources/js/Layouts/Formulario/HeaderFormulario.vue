<template>
    <header class="z-10 py-0 bg-white shadow-md flex" style="background:#1a2843; height: 54px; color: white;" >
      <div>
          <Link class="text-gray-100" :href="route('dashboard')">
            <div class="flex w-full" style="width: 230px;">
                <div class="logo-pos">
                  <div style="width: 30px; height: 30px;" class="mr-1 ml-2">
                    <img src="../../../../public/imagenes/logotiny.png"/>
                  </div>
                </div>
                <div class="flex nomb">
                    <div class="mt-1">
      ...
      <div class="container flex justify-between items-start px-0 mx-auto h-full md:justify-end" style="position: relative">     
  
          <div style="margin-top: 8px;">
            <button @click="$page.props.showingMobileMenu = !$page.props.showingMobileMenu" class="p-1 mr-0 ml-1 rounded-md md:hidden focus:outline-none focus:shadow-outline-purple" aria-label="Menu">
        ...
        <Dropdown class="mr-2" v-if="usuario.usuario != null" style="cursor: pointer;">
          <template #trigger >
            <div class="flex" style="align-items: center; height: 37px; margin-top: 8px;">
            <div style="text-align: end;  margin-top: 0px;">
              <div style="margin-top: -7px;">
                <span style="font-size: 0.8rem; font-weight: bold; color: white;">{{ usuario.usuario.nombres }} {{ usuario.usuario.paterno }} </span>
              </div>
              <div style=" width: 200px; margin-top: -10px; white-space: nowrap; text-overflow: ellipsis; overflow: hidden;">
                <span style="font-size: 0.7rem; text-transform: uppercase; ">{{ usuario.usuario.rol }}</span> 
              </div>
            </div>
        ...
        <!-- <Dropdown v-else>
          <template #trigger >
            <div class="flex" style="align-items: center; height: 37px; color: white;">
            <div class="pt-4" style="text-align: end;  margin-top: 0px;">
              <div style=" width: 200px; white-space: nowrap; text-overflow: ellipsis; overflow: hidden;">
                <span style="font-size: 0.8rem;">Administrador </span>
              </div>
              <div style="margin-top: -7px;">
                <span style="font-size: 0.8rem; font-weight: bold;"> Usuario </span>
              </div>
            </div>
            <div style="margin-left: 10px;">
                <svg class="mr-3 w-4 h-4" aria-hidden="true" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
...
<style>
.logo-pos{ margin-top: 10px; }
@media only screen and (max-width: 767px) { 
  .nomb { display: none; }
  .logo-pos{ margin-top: 20px; }
}
</style>