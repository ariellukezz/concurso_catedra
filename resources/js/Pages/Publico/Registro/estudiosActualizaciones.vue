<template>
    <Head title="Registro de actualizaciones" />
    <Layout>
        <div class="p-4" style="height: calc(100vh - 63px);">
                        ...
                        <a-card class="p-0">
                            <div class="flex justify-between" style="margin: -15px -10px;">
                                ...
                                <div class="flex" style="margin-top: 0px;">
                                    ...
                                    <a-button danger @click="eliminarPublicacion(titulo.id)" style="width: 20px; height: 20px; padding-left: 3px;">
            ...
            <a-modal v-model:open="modaltitulo" title="Registro de estudios o actualizaciones" @ok="handleOk">
                <a-form
                    ref="formDatos"
                    name="form"
                    :model="form" 
...
const eliminarPublicacion = async (id) => {
    let res = await axios.get("/eliminar-publicacion/"+id)
    if (res.data.estado == true) {
        getEstudios()
    } else {
        console.log("Ocurrió un error");
